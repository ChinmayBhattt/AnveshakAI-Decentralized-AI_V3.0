...
function weierstrassN(CURVE, curveOpts = {}) {
  ...
  const assertValidMemo = memoized((p) => {
    if (p.is0()) {
      if (curveOpts.allowInfinityPoint && !Fp4.is0(p.Y))
        return;
...
function eddsa(Point, cHash, eddsaOpts) {
  ...
  const { BASE: G, Fp: Fp4, Fn: Fn2 } = Point;
...
`);
  ...
  async syncTime(canisterId) {
    await __classPrivateFieldGet4(this, _HttpAgent_instances, "m", _HttpAgent_rootKeyGuard).call(this);
    const CanisterStatus = await import("./canisterStatus-SD7P3UAM.js");
...
@noble/curves/esm/ed25519.js:
  (*! noble-curves - MIT License (c) 2022 Paul Miller (paulmillr.com) *)
*/
//# sourceMappingURL=chunk-QPNLMZP6.js.map
